...
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/lib.core/pattern-search.c -o $PWD/lib.core/pattern-search.o
...
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/lib.core/pattern-whitespace.c -o $PWD/lib.core/pattern-whitespace.o
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/lib.core/pattern-path-match.c -o $PWD/lib.core/pattern-path-match.o
...
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/lib.core/pattern-path.c -o $PWD/lib.core/pattern-path.o
...
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/lib.core/pattern-branch.c -o $PWD/lib.core/pattern-branch.o
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/lib.core/pattern-token.c -o $PWD/lib.core/pattern-token.o
...
ar rsc $PWD/lib.core/lib.core.a $PWD/lib.core/permute.o $PWD/lib.core/object.o $PWD/lib.core/memory.o $PWD/lib.core/pattern-search.o $PWD/lib.core/random.o $PWD/lib.core/convert.o $PWD/lib.core/topological.o $PWD/lib.core/defines.o $PWD/lib.core/combinations.o $PWD/lib.core/stopwatch.o $PWD/lib.core/error.o $PWD/lib.core/string.o $PWD/lib.core/pattern-whitespace.o $PWD/lib.core/pattern-path-match.o $PWD/lib.core/file.o $PWD/lib.core/pattern-path.o $PWD/lib.core/tree.o $PWD/lib.core/file-reader.o $PWD/lib.core/tainio-tree.o $PWD/lib.core/pattern-branch.o $PWD/lib.core/pattern-token.o $PWD/lib.core/ascii.o $PWD/lib.core/list.o 
...
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/lib.compile/compile-print.c -o $PWD/lib.compile/compile-print.o
...
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/app.test.lib.compile/test.c -o $PWD/app.test.lib.compile/test.o
gcc -lrt -lm $PWD/app.test.lib.compile/test-compile-project.o $PWD/app.test.lib.compile/test-compile.o $PWD/app.test.lib.compile/test.o $PWD/lib.test/lib.test.a $PWD/lib.compile/lib.compile.a $PWD/lib.core/lib.core.a -O3 -o $PWD/app.test.lib.compile/app.test.lib.compile 1>/dev/null
...
gcc -lrt -lm $PWD/app.pattern.replace/main.o $PWD/lib.core/lib.core.a -O3 -o $PWD/app.pattern.replace/app.pattern.replace 1>/dev/null
...
gcc -lrt -lm $PWD/app.pattern.search/main.o $PWD/lib.core/lib.core.a -O3 -o $PWD/app.pattern.search/app.pattern.search 1>/dev/null
...
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/app.test.lib.core/test-pattern-branch.c -o $PWD/app.test.lib.core/test-pattern-branch.o
...
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/app.test.lib.core/test-pattern-path.c -o $PWD/app.test.lib.core/test-pattern-path.o
...
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/app.test.lib.core/test-pattern-token.c -o $PWD/app.test.lib.core/test-pattern-token.o
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/app.test.lib.core/test-pattern-whitespace.c -o $PWD/app.test.lib.core/test-pattern-whitespace.o
...
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/app.test.lib.core/test-pattern-path-match.c -o $PWD/app.test.lib.core/test-pattern-path-match.o
...
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/app.test.lib.core/test.c -o $PWD/app.test.lib.core/test.o
...
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/app.test.lib.core/test-pattern-search.c -o $PWD/app.test.lib.core/test-pattern-search.o
...
gcc -lrt -lm $PWD/app.test.lib.core/test-list.o $PWD/app.test.lib.core/test-object.o $PWD/app.test.lib.core/test-memory.o $PWD/app.test.lib.core/test-pattern-branch.o $PWD/app.test.lib.core/test-file.o $PWD/app.test.lib.core/test-defines.o $PWD/app.test.lib.core/test-pattern-path.o $PWD/app.test.lib.core/test-stopwatch.o $PWD/app.test.lib.core/test-permute.o $PWD/app.test.lib.core/test-pattern-token.o $PWD/app.test.lib.core/test-pattern-whitespace.o $PWD/app.test.lib.core/test-tree.o $PWD/app.test.lib.core/test-random.o $PWD/app.test.lib.core/test-pattern-path-match.o $PWD/app.test.lib.core/test-combinations.o $PWD/app.test.lib.core/test-string.o $PWD/app.test.lib.core/test-tainio-tree.o $PWD/app.test.lib.core/test-error.o $PWD/app.test.lib.core/test.o $PWD/app.test.lib.core/test-ascii.o $PWD/app.test.lib.core/test-pattern-search.o $PWD/app.test.lib.core/test-topological.o $PWD/app.test.lib.core/test-convert.o $PWD/lib.test/lib.test.a $PWD/lib.core/lib.core.a -O3 -o $PWD/app.test.lib.core/app.test.lib.core 1>/dev/null
gcc -std=gnu99 -O3 -pedantic -g -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/app.print_directory/main.c -o $PWD/app.print_directory/main.o
gcc -lrt -lm $PWD/app.print_directory/main.o $PWD/lib.core/lib.core.a -O3 -o $PWD/app.print_directory/app.print_directory 1>/dev/null
