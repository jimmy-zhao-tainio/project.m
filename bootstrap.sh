...
ar rsc $PWD/lib.core/lib.core.a $PWD/lib.core/object.o $PWD/lib.core/defines.o $PWD/lib.core/tree.o $PWD/lib.core/topological.o $PWD/lib.core/error.o $PWD/lib.core/memory.o $PWD/lib.core/random.o $PWD/lib.core/string.o $PWD/lib.core/file-reader.o $PWD/lib.core/stopwatch.o $PWD/lib.core/permute.o $PWD/lib.core/combinations.o $PWD/lib.core/tainio-tree.o $PWD/lib.core/ascii.o $PWD/lib.core/list.o $PWD/lib.core/convert.o $PWD/lib.core/file.o 
...
ar rsc $PWD/lib.compile/lib.compile.a $PWD/lib.compile/compile-print.o $PWD/lib.compile/compile.o $PWD/lib.compile/compile-project.o $PWD/lib.core/lib.core.a 
...
gcc -lrt -lm $PWD/app.test.lib.compile/test-compile-project.o $PWD/app.test.lib.compile/test.o $PWD/app.test.lib.compile/test-compile.o $PWD/lib.compile/lib.compile.a $PWD/lib.test/lib.test.a $PWD/lib.core/lib.core.a -O3 -o $PWD/app.test.lib.compile/app.test.lib.compile 1>/dev/null
...
gcc -lrt -lm $PWD/app.test.lib.core/test-defines.o $PWD/app.test.lib.core/test-list.o $PWD/app.test.lib.core/test-tainio-tree.o $PWD/app.test.lib.core/test-ascii.o $PWD/app.test.lib.core/test-object.o $PWD/app.test.lib.core/test-topological.o $PWD/app.test.lib.core/test-file.o $PWD/app.test.lib.core/test-string.o $PWD/app.test.lib.core/test-tree.o $PWD/app.test.lib.core/test-error.o $PWD/app.test.lib.core/test-stopwatch.o $PWD/app.test.lib.core/test.o $PWD/app.test.lib.core/test-permute.o $PWD/app.test.lib.core/test-random.o $PWD/app.test.lib.core/test-memory.o $PWD/app.test.lib.core/test-convert.o $PWD/app.test.lib.core/test-combinations.o $PWD/lib.test/lib.test.a $PWD/lib.core/lib.core.a -O3 -o $PWD/app.test.lib.core/app.test.lib.core 1>/dev/null
...
ar rsc $PWD/lib.app/lib.app.a $PWD/lib.app/arguments.o $PWD/lib.core/lib.core.a 
...
gcc -lrt -lm $PWD/app.test.lib.app/test-arguments.o $PWD/app.test.lib.app/test.o $PWD/lib.app/lib.app.a $PWD/lib.test/lib.test.a $PWD/lib.core/lib.core.a -O3 -o $PWD/app.test.lib.app/app.test.lib.app 1>/dev/null
...
ar rsc $PWD/lib.pattern/lib.pattern.a $PWD/lib.pattern/pattern-path-match.o $PWD/lib.pattern/pattern-token.o $PWD/lib.pattern/pattern-path.o $PWD/lib.pattern/pattern-branch.o $PWD/lib.pattern/pattern-whitespace.o $PWD/lib.pattern/pattern-search.o $PWD/lib.core/lib.core.a 
...
gcc -lrt -lm $PWD/app.random.number/main.o $PWD/lib.core/lib.core.a -O3 -o $PWD/app.random.number/app.random.number 1>/dev/null
...
gcc -lrt -lm $PWD/app.test.lib.pattern/test-pattern-path-match.o $PWD/app.test.lib.pattern/test-pattern-token.o $PWD/app.test.lib.pattern/test-pattern-branch.o $PWD/app.test.lib.pattern/test-pattern-path.o $PWD/app.test.lib.pattern/test.o $PWD/app.test.lib.pattern/test-pattern-whitespace.o $PWD/app.test.lib.pattern/test-pattern-search.o $PWD/lib.pattern/lib.pattern.a $PWD/lib.test/lib.test.a $PWD/lib.core/lib.core.a -O3 -o $PWD/app.test.lib.pattern/app.test.lib.pattern 1>/dev/null
