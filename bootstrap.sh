...
clang -std=gnu99 -pedantic -g -O3 -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/lib.core/pattern-path-match.c -o $PWD/lib.core/pattern-path-match.o
...
clang -std=gnu99 -pedantic -g -O3 -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/lib.core/pattern-path.c -o $PWD/lib.core/pattern-path.o
...
ar rsc $PWD/lib.core/lib.core.a $PWD/lib.core/error.o $PWD/lib.core/random.o $PWD/lib.core/stopwatch.o $PWD/lib.core/permute.o $PWD/lib.core/file.o $PWD/lib.core/list.o $PWD/lib.core/pattern-path-match.o $PWD/lib.core/pattern-token.o $PWD/lib.core/pattern-whitespace.o $PWD/lib.core/string.o $PWD/lib.core/pattern-path.o $PWD/lib.core/combinations.o $PWD/lib.core/memory.o $PWD/lib.core/pattern-branch.o $PWD/lib.core/topological.o $PWD/lib.core/object.o $PWD/lib.core/convert.o $PWD/lib.core/tree.o $PWD/lib.core/tainio-tree.o $PWD/lib.core/file-reader.o $PWD/lib.core/defines.o $PWD/lib.core/ascii.o 
...
clang -O3 -lrt -lm $PWD/app.test.lib.compile/test-compile-project.o $PWD/app.test.lib.compile/test.o $PWD/app.test.lib.compile/test-compile.o $PWD/lib.test/lib.test.a $PWD/lib.compile/lib.compile.a $PWD/lib.core/lib.core.a -o $PWD/app.test.lib.compile/app.test.lib.compile 1>/dev/null
...
clang -std=gnu99 -pedantic -g -O3 -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/app.test.lib.core/test-pattern-path.c -o $PWD/app.test.lib.core/test-pattern-path.o
clang -std=gnu99 -pedantic -g -O3 -Wall -Wextra -Wconversion -Wformat-security -Werror -I$PWD -c $PWD/app.test.lib.core/test-pattern-path-match.c -o $PWD/app.test.lib.core/test-pattern-path-match.o
...
clang -O3 -lrt -lm $PWD/app.test.lib.core/test-tainio-tree.o $PWD/app.test.lib.core/test-ascii.o $PWD/app.test.lib.core/test-file.o $PWD/app.test.lib.core/test-combinations.o $PWD/app.test.lib.core/test-pattern-branch.o $PWD/app.test.lib.core/test-convert.o $PWD/app.test.lib.core/test-error.o $PWD/app.test.lib.core/test-memory.o $PWD/app.test.lib.core/test-defines.o $PWD/app.test.lib.core/test.o $PWD/app.test.lib.core/test-string.o $PWD/app.test.lib.core/test-object.o $PWD/app.test.lib.core/test-permute.o $PWD/app.test.lib.core/test-pattern-path.o $PWD/app.test.lib.core/test-pattern-path-match.o $PWD/app.test.lib.core/test-random.o $PWD/app.test.lib.core/test-pattern-token.o $PWD/app.test.lib.core/test-tree.o $PWD/app.test.lib.core/test-stopwatch.o $PWD/app.test.lib.core/test-pattern-whitespace.o $PWD/app.test.lib.core/test-topological.o $PWD/app.test.lib.core/test-list.o $PWD/lib.test/lib.test.a $PWD/lib.core/lib.core.a -o $PWD/app.test.lib.core/app.test.lib.core 1>/dev/null
