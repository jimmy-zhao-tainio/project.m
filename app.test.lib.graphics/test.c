...
bool (*tests[]) (Test *test) =
{
        ...
        &test_canvas_create_function_call_4,
        &test_canvas_create,
        ...
        &test_canvas_draw_image_function_call_1,
        &test_canvas_draw_image_function_call_2,
        ...
        &test_canvas_fill_rectangle_with_color_function_call_1,
        &test_canvas_fill_rectangle_with_color_function_call_2,
        ...
        &test_canvas_fill_rectangle_with_image_function_call_1,
        &test_canvas_fill_rectangle_with_image_function_call_2,
