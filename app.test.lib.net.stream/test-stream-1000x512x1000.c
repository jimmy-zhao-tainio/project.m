...
bool test_stream_1000x512x1000 (Test *test)
{
                                   ...
                                   NetStreamPackage package)
{
        ...
        count = server_read;
        thread_unlock (&server_lock);
        if (count >= (size_t)CONNECTIONS * (size_t)BUFFER_SIZE * (size_t)BUFFER_REPEAT) {
...
static void client_on_connect_error (NetClient *client, NetClientConnection *connection)
{
        // If you're reading this you need to configure your system to allow more 
