...
bool (*tests[]) (Test *test) =
{
        ...
        &test_convert_string_decimal_to_size_t_invalid_argument_1,
        &test_convert_string_decimal_to_size_t_invalid_argument_2,
        &test_convert_string_decimal_to_size_t_invalid_operation_1,
        &test_convert_string_decimal_to_size_t_invalid_operation_2,
        &test_convert_string_decimal_to_size_t_overflow_1,
        &test_convert_string_decimal_to_size_t_overflow_2,
        &test_convert_string_decimal_to_size_t_overflow_3,
        &test_convert_string_decimal_to_size_t,
        ...
        &test_pattern_tokens_string_to_size_t,
        ...
        &test_pattern_path_create_branch_function_call_1,
        &test_pattern_path_create_branch_function_call_2,
        &test_pattern_path_create_branch,
        &test_pattern_path_create_not_function_call,
        &test_pattern_path_create_not_range,
        &test_pattern_path_create_not_set,
        &test_pattern_path_create_not_value,
        &test_pattern_path_create_or_function_call_1,
        &test_pattern_path_create_or_function_call_2,
        &test_pattern_path_create_or_function_call_3,
        &test_pattern_path_create_or,
        &test_pattern_path_create_repeat_function_call_1,
        &test_pattern_path_create_repeat_function_call_2,
        &test_pattern_path_create_repeat,
        &test_pattern_path_create_range_function_call,
        &test_pattern_path_create_range,
        &test_pattern_path_create_set_function_call,
        &test_pattern_path_create_set,
        &test_pattern_path_create_value_function_call,
        &test_pattern_path_create_value,
        &test_pattern_path_destroy,
        NULL
};
