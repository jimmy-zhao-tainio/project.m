...
bool (*tests[]) (Test *test) =
{
        ...
        &test_convert_string_to_unsigned_long_long_overflow_1,
        &test_convert_string_to_unsigned_long_long_overflow_2,
        &test_convert_string_to_unsigned_long_long_overflow_3,
